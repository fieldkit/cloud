...
func (rr *MessageSchemaRepository) QuerySchemasPendingProcessing(ctx context.Context) ([]*WebHookSchemaRegistration, error) {
...
func (rr *MessageSchemaRepository) QuerySchemas(ctx context.Context, batch *MessageBatch) (map[int32]*WebHookSchemaRegistration, error) {
