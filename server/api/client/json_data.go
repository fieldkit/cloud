...
func (c *Client) NewGetJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, page *int, pageSize *int, start *int) (*http.Request, error) {
	...
	if start != nil {
		tmp144 := strconv.Itoa(*start)
		values.Set("start", tmp144)
	}
...
func (c *Client) NewSummaryJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, interval *int, page *int, pageSize *int, resolution *int, start *int) (*http.Request, error) {
	...
	if interval != nil {
		tmp147 := strconv.Itoa(*interval)
		values.Set("interval", tmp147)
	}
	if page != nil {
	...
	if pageSize != nil {
		tmp149 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp149)
	}
	if resolution != nil {
		tmp150 := strconv.Itoa(*resolution)
		values.Set("resolution", tmp150)
	}
	if start != nil {
		tmp151 := strconv.Itoa(*start)
		values.Set("start", tmp151)
	}
	u.RawQuery = values.Encode()
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
