...
func (c *Client) NewGetJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, page *int, pageSize *int, start *int) (*http.Request, error) {
	...
	if page != nil {
		tmp137 := strconv.Itoa(*page)
		values.Set("page", tmp137)
	}
	if pageSize != nil {
		tmp138 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp138)
	}
	if start != nil {
		tmp139 := strconv.Itoa(*start)
		values.Set("start", tmp139)
	}
...
func (c *Client) NewSummaryJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, interval *int, page *int, pageSize *int, resolution *int, start *int) (*http.Request, error) {
	...
	values := u.Query()
	if end != nil {
		tmp140 := strconv.Itoa(*end)
		values.Set("end", tmp140)
	}
	if internal != nil {
		tmp141 := strconv.FormatBool(*internal)
		values.Set("internal", tmp141)
	}
	if interval != nil {
		tmp142 := strconv.Itoa(*interval)
		values.Set("interval", tmp142)
	}
	if page != nil {
	...
	if pageSize != nil {
		tmp144 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp144)
	}
	if resolution != nil {
		tmp145 := strconv.Itoa(*resolution)
		values.Set("resolution", tmp145)
	}
	if start != nil {
		tmp146 := strconv.Itoa(*start)
		values.Set("start", tmp146)
	}
	u.RawQuery = values.Encode()
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
