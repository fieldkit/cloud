...
func (c *Client) NewGetJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, page *int, pageSize *int, start *int) (*http.Request, error) {
	...
	values := u.Query()
	if end != nil {
		tmp145 := strconv.Itoa(*end)
		values.Set("end", tmp145)
	}
	if internal != nil {
		tmp146 := strconv.FormatBool(*internal)
		values.Set("internal", tmp146)
	}
	if page != nil {
	...
	if pageSize != nil {
		tmp148 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp148)
	}
	if start != nil {
		tmp149 := strconv.Itoa(*start)
		values.Set("start", tmp149)
	}
...
func (c *Client) NewSummaryJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, interval *int, page *int, pageSize *int, resolution *int, start *int) (*http.Request, error) {
	...
	values := u.Query()
	if end != nil {
		tmp150 := strconv.Itoa(*end)
		values.Set("end", tmp150)
	}
	if internal != nil {
		tmp151 := strconv.FormatBool(*internal)
		values.Set("internal", tmp151)
	}
	if interval != nil {
		tmp152 := strconv.Itoa(*interval)
		values.Set("interval", tmp152)
	}
	if page != nil {
	...
	if resolution != nil {
		tmp155 := strconv.Itoa(*resolution)
		values.Set("resolution", tmp155)
	}
	if start != nil {
		tmp156 := strconv.Itoa(*start)
		values.Set("start", tmp156)
	}
	u.RawQuery = values.Encode()
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
