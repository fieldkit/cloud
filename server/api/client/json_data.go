...
func (c *Client) NewGetJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, page *int, pageSize *int, start *int) (*http.Request, error) {
	...
	values := u.Query()
	if end != nil {
		tmp144 := strconv.Itoa(*end)
		values.Set("end", tmp144)
	}
	if internal != nil {
		tmp145 := strconv.FormatBool(*internal)
		values.Set("internal", tmp145)
	}
	if page != nil {
	...
	if pageSize != nil {
		tmp147 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp147)
	}
	if start != nil {
...
func (c *Client) NewSummaryJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, interval *int, page *int, pageSize *int, resolution *int, start *int) (*http.Request, error) {
	...
	values := u.Query()
	if end != nil {
		tmp149 := strconv.Itoa(*end)
		values.Set("end", tmp149)
	}
	if internal != nil {
		tmp150 := strconv.FormatBool(*internal)
		values.Set("internal", tmp150)
	}
	if interval != nil {
		tmp151 := strconv.Itoa(*interval)
		values.Set("interval", tmp151)
	}
	if page != nil {
	...
	if pageSize != nil {
		tmp153 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp153)
	}
	if resolution != nil {
		tmp154 := strconv.Itoa(*resolution)
		values.Set("resolution", tmp154)
	}
	if start != nil {
