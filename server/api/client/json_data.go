...
func (c *Client) NewGetJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, page *int, pageSize *int, start *int) (*http.Request, error) {
	...
	values := u.Query()
	if end != nil {
		tmp241 := strconv.Itoa(*end)
		values.Set("end", tmp241)
	}
	if internal != nil {
		tmp242 := strconv.FormatBool(*internal)
		values.Set("internal", tmp242)
	}
	if page != nil {
		tmp243 := strconv.Itoa(*page)
		values.Set("page", tmp243)
	}
	if pageSize != nil {
		tmp244 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp244)
	}
	if start != nil {
		tmp245 := strconv.Itoa(*start)
		values.Set("start", tmp245)
	}
...
func (c *Client) NewSummaryJSONDataRequest(ctx context.Context, path string, end *int, internal *bool, interval *int, page *int, pageSize *int, resolution *int, start *int) (*http.Request, error) {
	...
	if interval != nil {
		tmp248 := strconv.Itoa(*interval)
		values.Set("interval", tmp248)
	}
	if page != nil {
		tmp249 := strconv.Itoa(*page)
		values.Set("page", tmp249)
	}
	if pageSize != nil {
	...
	if resolution != nil {
		tmp251 := strconv.Itoa(*resolution)
		values.Set("resolution", tmp251)
	}
	if start != nil {
