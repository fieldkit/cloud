...
func (c *Client) CheckFirmware(ctx context.Context, path string, ifNoneMatch *string) (*http.Response, error) {
	req, err := c.NewCheckFirmwareRequest(ctx, path, ifNoneMatch)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewCheckFirmwareRequest(ctx context.Context, path string, ifNoneMatch *string) (*http.Request, error) {
	scheme := c.Scheme
	if scheme == "" {
		scheme = "https"
	}
