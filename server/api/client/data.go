...
func (c *Client) NewDeviceDataDataRequest(ctx context.Context, path string, firstBlock *int, lastBlock *int, page *int, pageSize *int) (*http.Request, error) {
	...
	values := u.Query()
	if firstBlock != nil {
		tmp147 := strconv.Itoa(*firstBlock)
		values.Set("firstBlock", tmp147)
	}
	if lastBlock != nil {
		tmp148 := strconv.Itoa(*lastBlock)
		values.Set("lastBlock", tmp148)
	}
	if page != nil {
	...
	if pageSize != nil {
		tmp150 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp150)
	}
