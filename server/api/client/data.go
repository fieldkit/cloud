...
func (c *Client) NewDeviceDataDataRequest(ctx context.Context, path string, firstBlock *int, lastBlock *int, page *int, pageSize *int) (*http.Request, error) {
	...
	values := u.Query()
	if firstBlock != nil {
		tmp235 := strconv.Itoa(*firstBlock)
		values.Set("firstBlock", tmp235)
	}
	if lastBlock != nil {
		tmp236 := strconv.Itoa(*lastBlock)
		values.Set("lastBlock", tmp236)
	}
	if page != nil {
	...
	if pageSize != nil {
		tmp238 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp238)
	}
