...
func (c *Client) NewDeviceDataDataRequest(ctx context.Context, path string, firstBlock *int, lastBlock *int, page *int, pageSize *int) (*http.Request, error) {
	...
	values := u.Query()
	if firstBlock != nil {
		tmp251 := strconv.Itoa(*firstBlock)
		values.Set("firstBlock", tmp251)
	}
	if lastBlock != nil {
		tmp252 := strconv.Itoa(*lastBlock)
		values.Set("lastBlock", tmp252)
	}
	if page != nil {
	...
	if pageSize != nil {
		tmp254 := strconv.Itoa(*pageSize)
		values.Set("pageSize", tmp254)
	}
