...
//
// API "fieldkit": DeviceLogs Resource Client
//
// Command:
// $ main
...
// AllDeviceLogsPath computes a request path to the all action of DeviceLogs.
...
// NewAllDeviceLogsRequest create the request corresponding to the all action endpoint of the DeviceLogs resource.
