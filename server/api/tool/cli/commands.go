...

{
   ...
   "url": "Modi omnis possimus eveniet."
	...
	tmp104 := new(AddAdministratorCommand)
	sub = &cobra.Command{
...

{
   ...
   "name": "Voluptas sapiente pariatur doloribus."
	...
	command.AddCommand(sub)
	tmp106 := new(AddExpeditionCommand)
	sub = &cobra.Command{
...

{
   ...
   "slug": "zoszx1gdtn"
	...
	command.AddCommand(sub)
	tmp107 := new(AddFieldNoteCommand)
	sub = &cobra.Command{
...

{
   ...
   "tags": "Iure iusto dolores voluptatum eveniet."
	...
	command.AddCommand(sub)
	tmp110 := new(AddSourceTokenCommand)
	sub = &cobra.Command{
...

{
   ...
   "status_json": {
	...
	command.AddCommand(sub)
	tmp112 := new(AddStationLogCommand)
	sub = &cobra.Command{
...

{
   ...
   "password": "kjpejfm10j"
	...
	tmp116 := new(AddMultipleStationLogCommand)
	sub = &cobra.Command{
...

{
   "station_logs": [
	...
	tmp117 := new(AllDeviceDataCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp118 := new(AllDeviceLogsCommand)
	sub = &cobra.Command{
	...
	tmp119 := new(CallbackTwitterCommand)
	sub = &cobra.Command{
	...
	tmp120 := new(CheckFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp123 := new(DeleteAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp125 := new(DeleteFieldNoteCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp126 := new(DeleteMemberCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp127 := new(DeleteSourceTokenCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp128 := new(DeleteStationCommand)
	sub = &cobra.Command{
	...
	tmp130 := new(DeviceDataDataCommand)
	sub = &cobra.Command{
	...
	tmp131 := new(DeviceInfoFilesCommand)
	sub = &cobra.Command{
	...
	tmp132 := new(DeviceSummaryDataCommand)
	sub = &cobra.Command{
	...
	tmp133 := new(DownloadSimpleCommand)
	sub = &cobra.Command{
	...
	tmp134 := new(ExpeditionGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp137 := new(GeographicalQueryGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp138 := new(GetAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp139 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp140 := new(GetFieldNoteCommand)
	sub = &cobra.Command{
		Use:   `field-note ["/stations/STATIONID/field-notes"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp145 := new(GetStationLogCommand)
	sub = &cobra.Command{
	...
	tmp147 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp148 := new(GetDeviceLocationHistoryFilesCommand)
	sub = &cobra.Command{
	...
	tmp149 := new(GetIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators/USERID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp151 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp153 := new(GetIDProjectCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp155 := new(GetIDTwitterCommand)
	sub = &cobra.Command{
	...
	tmp157 := new(GetLinesJSONDataCommand)
	sub = &cobra.Command{
	...
	tmp158 := new(GetMediaFieldNoteCommand)
	sub = &cobra.Command{
	...
	tmp159 := new(ListFirmwareCommand)
	sub = &cobra.Command{
		Use:   `firmware ["/firmware"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp160 := new(ListAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp162 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp166 := new(ListSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp171 := new(ListByIDGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp172 := new(ListBySourceExportCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp173 := new(ListBySourceGeojsonCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp174 := new(ListBySourceQueryCommand)
	sub = &cobra.Command{
	...
	tmp175 := new(ListCurrentProjectCommand)
	sub = &cobra.Command{
	...
	tmp176 := new(ListDeviceFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp177 := new(ListDeviceDataFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp178 := new(ListDeviceLogFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp179 := new(ListDevicesFilesCommand)
	sub = &cobra.Command{
	...
	tmp180 := new(ListExpeditionIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp181 := new(ListIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp182 := new(ListIDExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/projects/PROJECTID/expeditions"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp183 := new(ListIDMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp184 := new(ListIDSourceCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp185 := new(ListIDSourceTokenCommand)
	sub = &cobra.Command{
		Use:   `source-token ["/expeditions/EXPEDITIONID/source-tokens"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp187 := new(ListIDTwitterCommand)
	sub = &cobra.Command{
		Use:   `twitter ["/expeditions/EXPEDITIONID/sources/twitter-accounts"]`,
		Short: ``,
...

{
   ...
   "password": "3vz0x88eu3"
	...
	tmp190 := new(MyFeaturesSimpleCommand)
	sub = &cobra.Command{
	...
	tmp191 := new(MySimpleSummarySimpleCommand)
	sub = &cobra.Command{
	...
	tmp193 := new(ProcessIngestionDataCommand)
	sub = &cobra.Command{
	...
	tmp194 := new(ProjectGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp196 := new(RefreshTasksCommand)
	sub = &cobra.Command{
...

{
   "refresh_token": "Deleniti ut neque ut."
	...
	tmp198 := new(SaveMediaFieldNoteCommand)
	sub = &cobra.Command{
	...
	tmp200 := new(SummaryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp201 := new(TemporalClusterGeometryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp202 := new(UpdateFirmwareCommand)
	sub = &cobra.Command{
...

{
   ...
   "firmwareId": 393688216009588932
	...
	command.AddCommand(sub)
	tmp203 := new(UpdateDeviceCommand)
	sub = &cobra.Command{
		Use:   `device ["/sources/devices/ID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "name": "Rerum magni quia in veritatis illo."
	...
	command.AddCommand(sub)
	tmp204 := new(UpdateExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/expeditions/EXPEDITIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "zoszx1gdtn"
	...
	command.AddCommand(sub)
	tmp205 := new(UpdateFieldNoteCommand)
	sub = &cobra.Command{
		Use:   `field-note ["/stations/STATIONID/field-notes/FIELDNOTEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "note": "Voluptate quis voluptate ipsa fugiat culpa nulla."
	...
	command.AddCommand(sub)
	tmp206 := new(UpdateMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members/USERID"]`,
		Short: ``,
		Long: `
...

{
   "role": "Ut vero."
	...
	command.AddCommand(sub)
	tmp207 := new(UpdateProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "tags": "Iure iusto dolores voluptatum eveniet."
	...
	command.AddCommand(sub)
	tmp208 := new(UpdateSourceCommand)
	sub = &cobra.Command{
		Use:   `source ["/sources/SOURCEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "userId": 7331678635864459158
	...
	command.AddCommand(sub)
	tmp209 := new(UpdateStationCommand)
	sub = &cobra.Command{
		Use:   `station ["/stations/STATIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "status_json": {
	...
	command.AddCommand(sub)
	tmp210 := new(UpdateStationLogCommand)
	sub = &cobra.Command{
...

{
   ...
   "name": "8ah624i8r1"
	...
	tmp213 := new(UpdateDeviceInfoFilesCommand)
	sub = &cobra.Command{
		Use:   `files ["/devices/DEVICEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "notes": "Necessitatibus nostrum."
	...
	tmp214 := new(UpdateLocationDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "longitude": 0.38448358661460225
	...
	tmp215 := new(UpdateSchemaDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "key": "Accusamus voluptatibus."
	...
	tmp216 := new(UserGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp217 := new(UserSaveIDPictureCommand)
	sub = &cobra.Command{
		Use:   `picture ["/users/USERID/picture"]`,
		Short: ``,
	...
	tmp218 := new(ValidateUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/validate"]`,
		Short: ``,
...
func (cmd *ListBySourceGeojsonCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Descending != "" {
		var err error
		tmp219, err = boolVal(cmd.Descending)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--descending", "err", err)
			return err
		}
	}
	resp, err := c.ListBySourceGeoJSON(ctx, path, tmp219)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *RawFilesCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Dl != "" {
		var err error
		tmp221, err = boolVal(cmd.Dl)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--dl", "err", err)
			return err
		}
	}
	resp, err := c.RawFiles(ctx, path, tmp221)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *GetJSONDataCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Internal != "" {
		var err error
		tmp222, err = boolVal(cmd.Internal)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--internal", "err", err)
			return err
		}
	}
	resp, err := c.GetJSONData(ctx, path, intFlagVal("end", cmd.End), tmp222, intFlagVal("pageNumber", cmd.PageNumber), intFlagVal("pageSize", cmd.PageSize), intFlagVal("start", cmd.Start))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *GetLinesJSONDataCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Internal != "" {
		var err error
		tmp223, err = boolVal(cmd.Internal)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--internal", "err", err)
			return err
		}
	}
	resp, err := c.GetLinesJSONData(ctx, path, intFlagVal("end", cmd.End), tmp223, intFlagVal("pageNumber", cmd.PageNumber), intFlagVal("pageSize", cmd.PageSize), intFlagVal("start", cmd.Start))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
