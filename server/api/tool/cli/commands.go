...
{
   "etag": "Veritatis inventore incidunt quia.",
   "meta": "Quibusdam nisi ut.",
   "module": "Consequuntur ut in.",
   "profile": "Et est ea.",
   "url": "Sit asperiores autem."
}`,
	...
	tmp64 := new(AddAdministratorCommand)
	sub = &cobra.Command{
...
{
   "key": "Ex incidunt et maiores et nobis.",
   "name": "Maxime sunt exercitationem a dolores non minima."
}`,
	...
	command.AddCommand(sub)
	tmp66 := new(AddExpeditionCommand)
	sub = &cobra.Command{
...
{
   "description": "Quod voluptas non sit id.",
   "name": "Ipsa quam consectetur rerum.",
   "slug": "q9cd69as0l"
}`,
...
{
   "role": "Alias voluptates repellendus aut.",
   "userId": 742291223980693847
}`,
...
{
   "description": "Dignissimos suscipit voluptatem quae.",
   ...
   "slug": "90susr7y4n"
	...
	command.AddCommand(sub)
	tmp69 := new(AddSourceTokenCommand)
	sub = &cobra.Command{
...
{
   "device_id": "Est ut vel ut quod ad quisquam.",
   "name": "Doloremque quo vitae deleniti consequatur ipsa.",
   "status_json": {
      "Ea non.": false
   }
}`,
	...
	command.AddCommand(sub)
	tmp71 := new(AddStationLogCommand)
	sub = &cobra.Command{
...
{
   "ID": 4026894226044471355,
   "body": "Commodi repellendus tempora eos.",
   "station_id": 2442213595960922405,
   "timestamp": "Repellendus incidunt reprehenderit dolore fuga molestias commodi."
}`,
...
{
   "description": "Nisi excepturi ab modi tenetur et corporis.",
   "name": "0ofyin8408",
   "slug": "2ofem7iud7"
}`,
...
{
   "email": "emmett@greenbogan.info",
   "invite_token": "Optio perspiciatis explicabo ullam ea amet aspernatur.",
   "name": "n1f09iaiq9",
   "password": "u9zoszx1gd"
}`,
	...
	tmp75 := new(AddMultipleStationLogCommand)
	sub = &cobra.Command{
...

{
   "station_logs": [
	...
	tmp76 := new(AllDeviceDataCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp77 := new(AllDeviceLogsCommand)
	sub = &cobra.Command{
	...
	tmp78 := new(CallbackTwitterCommand)
	sub = &cobra.Command{
	...
	tmp79 := new(CheckFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp82 := new(DeleteAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp84 := new(DeleteSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp86 := new(DeviceInfoFilesCommand)
	sub = &cobra.Command{
	...
	tmp87 := new(DownloadSimpleCommand)
	sub = &cobra.Command{
	...
	tmp88 := new(ExpeditionGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp91 := new(GeographicalQueryGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp92 := new(GetAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp93 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp96 := new(GetStationCommand)
	sub = &cobra.Command{
		Use:   `station ["/stations/@/STATION"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp97 := new(GetStationLogCommand)
	sub = &cobra.Command{
	...
	tmp99 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp100 := new(GetDeviceLocationHistoryFilesCommand)
	sub = &cobra.Command{
	...
	tmp101 := new(GetIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators/USERID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp103 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp105 := new(GetIDProjectCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp107 := new(GetIDTwitterCommand)
	sub = &cobra.Command{
	...
	tmp109 := new(ListFirmwareCommand)
	sub = &cobra.Command{
		Use:   `firmware ["/firmware"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp110 := new(ListAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp112 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp116 := new(ListSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp121 := new(ListByIDGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp122 := new(ListBySourceExportCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp123 := new(ListBySourceGeojsonCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp124 := new(ListBySourceQueryCommand)
	sub = &cobra.Command{
	...
	tmp125 := new(ListCurrentProjectCommand)
	sub = &cobra.Command{
	...
	tmp126 := new(ListDeviceFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp127 := new(ListDeviceDataFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp128 := new(ListDeviceLogFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp129 := new(ListDevicesFilesCommand)
	sub = &cobra.Command{
	...
	tmp130 := new(ListExpeditionIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp131 := new(ListIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp132 := new(ListIDExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/projects/PROJECTID/expeditions"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp133 := new(ListIDMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp134 := new(ListIDSourceCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp135 := new(ListIDSourceTokenCommand)
	sub = &cobra.Command{
		Use:   `source-token ["/expeditions/EXPEDITIONID/source-tokens"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp137 := new(ListIDTwitterCommand)
	sub = &cobra.Command{
		Use:   `twitter ["/expeditions/EXPEDITIONID/sources/twitter-accounts"]`,
		Short: ``,
...
{
   "email": "diana_mclaughlin@jewess.biz",
   "password": "2yacoldg4n"
}`,
	...
	tmp140 := new(MyFeaturesSimpleCommand)
	sub = &cobra.Command{
	...
	tmp141 := new(MySimpleSummarySimpleCommand)
	sub = &cobra.Command{
	...
	tmp142 := new(ProjectGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp144 := new(RefreshTasksCommand)
	sub = &cobra.Command{
...
{
   "refresh_token": "Aliquid hic soluta ab quia enim rem."
}`,
	...
	tmp147 := new(SummaryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp148 := new(TemporalClusterGeometryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp149 := new(UpdateFirmwareCommand)
	sub = &cobra.Command{
...
{
   "deviceId": 442951363518267885,
   "firmwareId": 8088060880983347600
}`,
	...
	command.AddCommand(sub)
	tmp150 := new(UpdateDeviceCommand)
	sub = &cobra.Command{
		Use:   `device ["/sources/devices/ID"]`,
		Short: ``,
		Long: `
...
{
   "key": "Rerum cumque et aut sunt.",
   "name": "Qui asperiores amet aliquid et."
}`,
	...
	command.AddCommand(sub)
	tmp151 := new(UpdateExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/expeditions/EXPEDITIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "q9cd69as0l"
	...
	command.AddCommand(sub)
	tmp152 := new(UpdateMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members/USERID"]`,
		Short: ``,
		Long: `
...
{
   "role": "Quia reprehenderit voluptates consequatur sed."
}`,
	...
	command.AddCommand(sub)
	tmp153 := new(UpdateProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "90susr7y4n"
	...
	command.AddCommand(sub)
	tmp154 := new(UpdateSourceCommand)
	sub = &cobra.Command{
		Use:   `source ["/sources/SOURCEID"]`,
		Short: ``,
		Long: `
...
{
   "active": false,
   "name": "Magnam praesentium et necessitatibus harum doloremque ullam.",
   "teamId": 3517437443162009384,
   "userId": 2674357303679900026
}`,
	...
	command.AddCommand(sub)
	tmp155 := new(UpdateStationCommand)
	sub = &cobra.Command{
...
{
   "name": "Distinctio omnis.",
   "status_json": {
      "Ex alias sunt repellendus.": "5369a3ba-d40e-4e63-b4e7-a810de19927c"
   }
}`,
	...
	command.AddCommand(sub)
	tmp156 := new(UpdateStationLogCommand)
	sub = &cobra.Command{
...
{
   "bio": "Dignissimos possimus ut et tempore doloribus.",
   "email": "jaeden@beercole.info",
   "name": "zntdngxk4x"
}`,
	...
	tmp159 := new(UpdateDeviceInfoFilesCommand)
	sub = &cobra.Command{
		Use:   `files ["/devices/DEVICEID"]`,
		Short: ``,
		Long: `
...
{
   "deviceId": "Neque itaque tempora voluptatem sed unde vel.",
   "name": "Aut consequuntur quasi tempore facere tempora.",
   "notes": "Eveniet alias fuga."
}`,
	...
	tmp160 := new(UpdateLocationDeviceCommand)
	sub = &cobra.Command{
...
{
   "key": "Laudantium nam commodi consectetur molestiae explicabo.",
   "latitude": 0.9374491458904881,
   "longitude": 0.7161119903509889
}`,
	...
	tmp161 := new(UpdateSchemaDeviceCommand)
	sub = &cobra.Command{
...
{
   "active": false,
   "jsonSchema": "Quos odio voluptatibus omnis recusandae omnis.",
   "key": "Illo beatae officia dolores facere."
}`,
	...
	tmp162 := new(UserGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp163 := new(ValidateUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/validate"]`,
		Short: ``,
...
func (cmd *ListBySourceGeojsonCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Descending != "" {
		var err error
		tmp164, err = boolVal(cmd.Descending)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--descending", "err", err)
			return err
		}
	}
	resp, err := c.ListBySourceGeoJSON(ctx, path, tmp164)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *RawFilesCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Dl != "" {
		var err error
		tmp166, err = boolVal(cmd.Dl)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--dl", "err", err)
			return err
		}
	}
	resp, err := c.RawFiles(ctx, path, tmp166)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *GetStationCommand) Run(c *client.Client, args []string) error {
	...
	if len(args) > 0 {
		...
		path = fmt.Sprintf("/stations/@/%v", url.QueryEscape(cmd.Station))
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
...
func (cmd *GetStationCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var station string
	cc.Flags().StringVar(&cmd.Station, "station", station, ``)
}
