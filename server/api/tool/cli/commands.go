...

{
   ...
   "url": "Ex alias sunt repellendus."
	...
	tmp118 := new(AddAdministratorCommand)
	sub = &cobra.Command{
...

{
   ...
   "name": "Incidunt reprehenderit."
	...
	command.AddCommand(sub)
	tmp120 := new(AddExpeditionCommand)
	sub = &cobra.Command{
...

{
   ...
   "slug": "2vks5htqwo"
	...
	command.AddCommand(sub)
	tmp121 := new(AddFieldNoteCommand)
	sub = &cobra.Command{
...

{
   ...
   "tags": "Aut perspiciatis repellat."
	...
	command.AddCommand(sub)
	tmp124 := new(AddSourceTokenCommand)
	sub = &cobra.Command{
...

{
   ...
   "status_json": {
	...
	command.AddCommand(sub)
	tmp126 := new(AddStationLogCommand)
	sub = &cobra.Command{
...

{
   ...
   "password": "ia3bksz14z"
	...
	tmp130 := new(AddMultipleStationLogCommand)
	sub = &cobra.Command{
...

{
   "station_logs": [
	...
	tmp131 := new(AddStationProjectCommand)
	sub = &cobra.Command{
	...
	tmp133 := new(ChangePasswordUserCommand)
	sub = &cobra.Command{
...

{
   ...
   "oldPassword": "548ba7462s"
	...
	tmp134 := new(CheckFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp136 := new(DeleteFirmwareCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp137 := new(DeleteAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp139 := new(DeleteFieldNoteCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp140 := new(DeleteMemberCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp141 := new(DeleteProjectCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp142 := new(DeleteSourceTokenCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp143 := new(DeleteStationCommand)
	sub = &cobra.Command{
	...
	tmp145 := new(DeviceDataDataCommand)
	sub = &cobra.Command{
	...
	tmp147 := new(DownloadFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp149 := new(FilteredRecordsCommand)
	sub = &cobra.Command{
	...
	tmp150 := new(GetAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp151 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp152 := new(GetFieldNoteCommand)
	sub = &cobra.Command{
		Use:   `field-note ["/stations/STATIONID/field-notes"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp157 := new(GetStationLogCommand)
	sub = &cobra.Command{
	...
	tmp159 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp160 := new(GetCurrentUserImageUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user/media"]`,
		Short: ``,
	...
	tmp161 := new(GetIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators/USERID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp163 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp165 := new(GetIDProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp167 := new(GetIDTwitterCommand)
	sub = &cobra.Command{
	...
	tmp169 := new(GetImageProjectCommand)
	sub = &cobra.Command{
	...
	tmp170 := new(GetMediaFieldNoteCommand)
	sub = &cobra.Command{
	...
	tmp171 := new(GetUserImageUserCommand)
	sub = &cobra.Command{
	...
	tmp172 := new(InviteUserProjectCommand)
	sub = &cobra.Command{
...

{
   "email": "Expedita ut sequi enim officiis."
	...
	tmp173 := new(ListFirmwareCommand)
	sub = &cobra.Command{
		Use:   `firmware ["/firmware"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp174 := new(ListAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp176 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp180 := new(ListSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp184 := new(ListByProjectUserCommand)
	sub = &cobra.Command{
	...
	tmp188 := new(ListExpeditionIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp189 := new(ListIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp190 := new(ListIDExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/projects/PROJECTID/expeditions"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp191 := new(ListIDMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp192 := new(ListIDSourceCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp193 := new(ListIDSourceTokenCommand)
	sub = &cobra.Command{
		Use:   `source-token ["/expeditions/EXPEDITIONID/source-tokens"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp195 := new(ListIDTwitterCommand)
	sub = &cobra.Command{
		Use:   `twitter ["/expeditions/EXPEDITIONID/sources/twitter-accounts"]`,
		Short: ``,
	...
	tmp196 := new(ListProjectStationCommand)
	sub = &cobra.Command{
...

{
   ...
   "password": "vgc9gfbkjp"
	...
	tmp200 := new(PhotoStationCommand)
	sub = &cobra.Command{
	...
	tmp202 := new(ProcessIngestionDataCommand)
	sub = &cobra.Command{
	...
	tmp203 := new(ProjectGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp204 := new(ProjectRolesUserCommand)
	sub = &cobra.Command{
	...
	tmp205 := new(RecoveryUserCommand)
	sub = &cobra.Command{
...

{
   ...
   "token": "Dolores aliquam ea."
	...
	tmp206 := new(RecoveryLookupUserCommand)
	sub = &cobra.Command{
...

{
   "refresh_token": "Quas maiores eligendi veritatis laborum repellendus."
	...
	tmp208 := new(RemoveStationProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID/stations/STATIONID"]`,
		Short: ``,
...

{
   "email": "Exercitationem enim."
	...
	tmp210 := new(ResolvedRecordsCommand)
	sub = &cobra.Command{
	...
	tmp211 := new(SaveCurrentUserImageUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user/media"]`,
		Short: ``,
	...
	tmp212 := new(SaveImageProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID/media"]`,
		Short: ``,
	...
	tmp213 := new(SaveMediaFieldNoteCommand)
	sub = &cobra.Command{
	...
	tmp214 := new(SummaryJSONDataCommand)
	sub = &cobra.Command{
	...
	tmp215 := new(SummaryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp216 := new(TemporalClusterGeometryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp217 := new(TransmissionTokenUserCommand)
	sub = &cobra.Command{
	...
	tmp218 := new(UpdateFirmwareCommand)
	sub = &cobra.Command{
...

{
   ...
   "firmwareId": 4026894226044471355
	...
	command.AddCommand(sub)
	tmp219 := new(UpdateDeviceCommand)
	sub = &cobra.Command{
		Use:   `device ["/sources/devices/ID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "name": "Sequi nisi."
	...
	command.AddCommand(sub)
	tmp220 := new(UpdateExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/expeditions/EXPEDITIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "2vks5htqwo"
	...
	command.AddCommand(sub)
	tmp221 := new(UpdateFieldNoteCommand)
	sub = &cobra.Command{
		Use:   `field-note ["/stations/STATIONID/field-notes/FIELDNOTEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "note": "Recusandae suscipit modi omnis possimus eveniet tenetur."
	...
	command.AddCommand(sub)
	tmp222 := new(UpdateMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members/USERID"]`,
		Short: ``,
		Long: `
...

{
   "role": "Voluptas sapiente pariatur doloribus."
	...
	command.AddCommand(sub)
	tmp223 := new(UpdateProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "tags": "Aut perspiciatis repellat."
	...
	command.AddCommand(sub)
	tmp224 := new(UpdateSourceCommand)
	sub = &cobra.Command{
		Use:   `source ["/sources/SOURCEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "userId": 2746489687916955183
	...
	command.AddCommand(sub)
	tmp225 := new(UpdateStationCommand)
	sub = &cobra.Command{
		Use:   `station ["/stations/STATIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "status_json": {
	...
	command.AddCommand(sub)
	tmp226 := new(UpdateStationLogCommand)
	sub = &cobra.Command{
...

{
   ...
   "name": "411oholban"
	...
	tmp229 := new(UpdateLocationDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "longitude": 0.7441196201546744
	...
	tmp230 := new(UpdateSchemaDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "key": "A eum quis voluptas."
	...
	tmp231 := new(UserGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp232 := new(UserSaveIDPictureCommand)
	sub = &cobra.Command{
		Use:   `picture ["/users/USERID/picture"]`,
		Short: ``,
	...
	tmp233 := new(ValidateUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/validate"]`,
		Short: ``,
...
func (cmd *GetJSONDataCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Internal != "" {
		var err error
		tmp234, err = boolVal(cmd.Internal)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--internal", "err", err)
			return err
		}
	}
	resp, err := c.GetJSONData(ctx, path, intFlagVal("end", cmd.End), tmp234, intFlagVal("page", cmd.Page), intFlagVal("pageSize", cmd.PageSize), intFlagVal("start", cmd.Start))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *SummaryJSONDataCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Internal != "" {
		var err error
		tmp235, err = boolVal(cmd.Internal)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--internal", "err", err)
			return err
		}
	}
	resp, err := c.SummaryJSONData(ctx, path, intFlagVal("end", cmd.End), tmp235, intFlagVal("interval", cmd.Interval), intFlagVal("page", cmd.Page), intFlagVal("pageSize", cmd.PageSize), intFlagVal("resolution", cmd.Resolution), intFlagVal("start", cmd.Start))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
