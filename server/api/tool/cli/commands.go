...

{
   ...
   "username": "0voebzeo5q"
	...
	tmp10 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp14 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp15 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp18 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp22 := new(ListCurrentProjectCommand)
	sub = &cobra.Command{
