...

{
   ...
   "username": "0voebzeo5q"
	...
	tmp12 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp16 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp17 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp20 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp24 := new(ListCurrentProjectCommand)
	sub = &cobra.Command{
	...
	tmp25 := new(ListIDExpeditionCommand)
	sub = &cobra.Command{
