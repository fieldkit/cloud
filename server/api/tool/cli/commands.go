...
{
   "etag": "Molestiae a sed quis rerum accusantium quia.",
   "meta": "Nobis rerum dolor voluptas doloremque ea.",
   "module": "Ut tempore aut.",
   "profile": "Dolorem sunt nesciunt dolor.",
   "url": "Eum quia et occaecati ut sint."
}`,
...
{
   "key": "Necessitatibus doloribus.",
   "name": "Labore voluptatem rerum numquam voluptatem."
}`,
...

{
   ...
   "invite_token": "Distinctio commodi repellendus tempora.",
   "name": "tjblkmzepz",
   "password": "2lt4s3kt0o"
}`,
...

{
   ...
   "password": "40o2o0pnii"
	...
	tmp131 := new(ProjectGetIDPictureCommand)
	sub = &cobra.Command{
...
{
   "refresh_token": "Non rerum rerum magni quia in."
}`,
	...
	tmp135 := new(StreamsProcessTasksCommand)
	sub = &cobra.Command{
	...
	tmp136 := new(SummaryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp137 := new(TemporalClusterGeometryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp138 := new(UpdateFirmwareCommand)
	sub = &cobra.Command{
...
{
   "deviceId": 5151296618051548534,
   "firmwareId": 8269890283245765792
}`,
	...
	command.AddCommand(sub)
	tmp139 := new(UpdateDeviceCommand)
	sub = &cobra.Command{
		Use:   `device ["/sources/devices/ID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "name": "Ut doloremque consequuntur ut in quaerat."
	...
	command.AddCommand(sub)
	tmp140 := new(UpdateExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/expeditions/EXPEDITIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "qxc40imp6g"
	...
	command.AddCommand(sub)
	tmp141 := new(UpdateMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members/USERID"]`,
		Short: ``,
		Long: `
...

{
   "role": "Assumenda quod."
	...
	command.AddCommand(sub)
	tmp142 := new(UpdateProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "hnipyk1ltz"
	...
	command.AddCommand(sub)
	tmp143 := new(UpdateSourceCommand)
	sub = &cobra.Command{
		Use:   `source ["/sources/SOURCEID"]`,
		Short: ``,
		Long: `
...
{
   "bio": "Illo non molestias nulla consequatur.",
   ...
   "name": "3gib044grb"
	...
	tmp146 := new(UpdateDeviceInfoFilesCommand)
	sub = &cobra.Command{
		Use:   `files ["/devices/DEVICEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "notes": "Dolores facere veritatis quod voluptas non sit."
	...
	tmp147 := new(UpdateLocationDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "longitude": 0.6001835461511418
	...
	tmp148 := new(UpdateSchemaDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "key": "Incidunt et maiores et nobis quam."
	...
	tmp149 := new(UserGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp150 := new(ValidateUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/validate"]`,
		Short: ``,
...
func (cmd *RawFilesCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Dl != "" {
		var err error
		tmp153, err = boolVal(cmd.Dl)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--dl", "err", err)
			return err
		}
	}
	resp, err := c.RawFiles(ctx, path, tmp153)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
