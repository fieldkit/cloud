...

{
   ...
   "username": "1bm6qh9fli"
	...
	tmp71 := new(CallbackTwitterCommand)
	sub = &cobra.Command{
	...
	tmp72 := new(CheckFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp75 := new(DeleteAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp77 := new(DeleteSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp79 := new(ExpeditionGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp81 := new(GeographicalQueryGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp82 := new(GetAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp83 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp88 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp89 := new(GetIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators/USERID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp91 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp98 := new(ListAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp100 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp104 := new(ListSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp108 := new(ListAllStreamsCommand)
	sub = &cobra.Command{
	...
	tmp109 := new(ListByIDGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp110 := new(ListBySourceExportCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp111 := new(ListBySourceGeojsonCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp112 := new(ListBySourceQueryCommand)
	sub = &cobra.Command{
	...
	tmp113 := new(ListCurrentProjectCommand)
	sub = &cobra.Command{
	...
	tmp114 := new(ListDeviceFirmwareCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp115 := new(ListDeviceStreamsCommand)
	sub = &cobra.Command{
