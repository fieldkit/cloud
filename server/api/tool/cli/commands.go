...

{
   ...
   "url": "Modi omnis possimus eveniet."
	...
	tmp101 := new(AddAdministratorCommand)
	sub = &cobra.Command{
...

{
   ...
   "name": "Voluptas sapiente pariatur doloribus."
	...
	command.AddCommand(sub)
	tmp103 := new(AddExpeditionCommand)
	sub = &cobra.Command{
...

{
   ...
   "slug": "zoszx1gdtn"
	...
	command.AddCommand(sub)
	tmp104 := new(AddFieldNoteCommand)
	sub = &cobra.Command{
...

{
   ...
   "tags": "Iure iusto dolores voluptatum eveniet."
	...
	command.AddCommand(sub)
	tmp107 := new(AddSourceTokenCommand)
	sub = &cobra.Command{
...

{
   ...
   "status_json": {
	...
	command.AddCommand(sub)
	tmp109 := new(AddStationLogCommand)
	sub = &cobra.Command{
...

{
   ...
   "password": "kjpejfm10j"
	...
	tmp113 := new(AddMultipleStationLogCommand)
	sub = &cobra.Command{
...

{
   "station_logs": [
	...
	tmp114 := new(AllDeviceDataCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp115 := new(AllDeviceLogsCommand)
	sub = &cobra.Command{
	...
	tmp116 := new(CallbackTwitterCommand)
	sub = &cobra.Command{
	...
	tmp117 := new(CheckFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp120 := new(DeleteAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp122 := new(DeleteFieldNoteCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp123 := new(DeleteMemberCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp124 := new(DeleteSourceTokenCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp125 := new(DeleteStationCommand)
	sub = &cobra.Command{
	...
	tmp127 := new(DeviceDataDataCommand)
	sub = &cobra.Command{
	...
	tmp128 := new(DeviceInfoFilesCommand)
	sub = &cobra.Command{
	...
	tmp129 := new(DeviceSummaryDataCommand)
	sub = &cobra.Command{
	...
	tmp130 := new(DownloadSimpleCommand)
	sub = &cobra.Command{
	...
	tmp131 := new(ExpeditionGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp134 := new(GeographicalQueryGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp135 := new(GetAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp136 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp137 := new(GetFieldNoteCommand)
	sub = &cobra.Command{
		Use:   `field-note ["/stations/STATIONID/field-notes"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp142 := new(GetStationLogCommand)
	sub = &cobra.Command{
	...
	tmp144 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp145 := new(GetDeviceLocationHistoryFilesCommand)
	sub = &cobra.Command{
	...
	tmp146 := new(GetIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators/USERID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp148 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp150 := new(GetIDProjectCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp152 := new(GetIDTwitterCommand)
	sub = &cobra.Command{
	...
	tmp154 := new(GetLinesJSONDataCommand)
	sub = &cobra.Command{
	...
	tmp155 := new(ListFirmwareCommand)
	sub = &cobra.Command{
		Use:   `firmware ["/firmware"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp156 := new(ListAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp158 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp162 := new(ListSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp167 := new(ListByIDGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp168 := new(ListBySourceExportCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp169 := new(ListBySourceGeojsonCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp170 := new(ListBySourceQueryCommand)
	sub = &cobra.Command{
	...
	tmp171 := new(ListCurrentProjectCommand)
	sub = &cobra.Command{
	...
	tmp172 := new(ListDeviceFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp173 := new(ListDeviceDataFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp174 := new(ListDeviceLogFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp175 := new(ListDevicesFilesCommand)
	sub = &cobra.Command{
	...
	tmp176 := new(ListExpeditionIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp177 := new(ListIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp178 := new(ListIDExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/projects/PROJECTID/expeditions"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp179 := new(ListIDMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp180 := new(ListIDSourceCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp181 := new(ListIDSourceTokenCommand)
	sub = &cobra.Command{
		Use:   `source-token ["/expeditions/EXPEDITIONID/source-tokens"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp183 := new(ListIDTwitterCommand)
	sub = &cobra.Command{
		Use:   `twitter ["/expeditions/EXPEDITIONID/sources/twitter-accounts"]`,
		Short: ``,
...

{
   ...
   "password": "3vz0x88eu3"
	...
	tmp186 := new(MyFeaturesSimpleCommand)
	sub = &cobra.Command{
	...
	tmp187 := new(MySimpleSummarySimpleCommand)
	sub = &cobra.Command{
	...
	tmp189 := new(ProcessIngestionDataCommand)
	sub = &cobra.Command{
	...
	tmp190 := new(ProjectGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp192 := new(RefreshTasksCommand)
	sub = &cobra.Command{
...

{
   "refresh_token": "Deleniti ut neque ut."
	...
	tmp195 := new(SummaryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp196 := new(TemporalClusterGeometryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp197 := new(UpdateFirmwareCommand)
	sub = &cobra.Command{
...

{
   ...
   "firmwareId": 393688216009588932
	...
	command.AddCommand(sub)
	tmp198 := new(UpdateDeviceCommand)
	sub = &cobra.Command{
		Use:   `device ["/sources/devices/ID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "name": "Rerum magni quia in veritatis illo."
	...
	command.AddCommand(sub)
	tmp199 := new(UpdateExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/expeditions/EXPEDITIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "zoszx1gdtn"
	...
	command.AddCommand(sub)
	tmp200 := new(UpdateFieldNoteCommand)
	sub = &cobra.Command{
		Use:   `field-note ["/stations/STATIONID/field-notes/FIELDNOTEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "station_id": 407422941081086207
	...
	command.AddCommand(sub)
	tmp201 := new(UpdateMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members/USERID"]`,
		Short: ``,
		Long: `
...
{
   "role": "Quibusdam aspernatur ut vero."
}`,
	...
	command.AddCommand(sub)
	tmp202 := new(UpdateProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "tags": "Iure iusto dolores voluptatum eveniet."
	...
	command.AddCommand(sub)
	tmp203 := new(UpdateSourceCommand)
	sub = &cobra.Command{
		Use:   `source ["/sources/SOURCEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "userId": 7331678635864459158
	...
	command.AddCommand(sub)
	tmp204 := new(UpdateStationCommand)
	sub = &cobra.Command{
		Use:   `station ["/stations/STATIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "status_json": {
	...
	command.AddCommand(sub)
	tmp205 := new(UpdateStationLogCommand)
	sub = &cobra.Command{
...

{
   ...
   "name": "8ah624i8r1"
	...
	tmp208 := new(UpdateDeviceInfoFilesCommand)
	sub = &cobra.Command{
		Use:   `files ["/devices/DEVICEID"]`,
		Short: ``,
		Long: `
...
{
   "deviceId": "Eaque distinctio ipsam unde.",
   "name": "Optio voluptatem qui dolores dicta.",
   "notes": "Delectus nisi et reiciendis necessitatibus nostrum quia."
}`,
	...
	tmp209 := new(UpdateLocationDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "longitude": 0.38448358661460225
	...
	tmp210 := new(UpdateSchemaDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "key": "Accusamus voluptatibus."
	...
	tmp211 := new(UserGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp212 := new(UserSaveIDPictureCommand)
	sub = &cobra.Command{
		Use:   `picture ["/users/USERID/picture"]`,
		Short: ``,
	...
	tmp213 := new(ValidateUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/validate"]`,
		Short: ``,
...
func (cmd *ListBySourceGeojsonCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Descending != "" {
		var err error
		tmp214, err = boolVal(cmd.Descending)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--descending", "err", err)
			return err
		}
	}
	resp, err := c.ListBySourceGeoJSON(ctx, path, tmp214)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *RawFilesCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Dl != "" {
		var err error
		tmp216, err = boolVal(cmd.Dl)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--dl", "err", err)
			return err
		}
	}
	resp, err := c.RawFiles(ctx, path, tmp216)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *GetJSONDataCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Internal != "" {
		var err error
		tmp217, err = boolVal(cmd.Internal)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--internal", "err", err)
			return err
		}
	}
	resp, err := c.GetJSONData(ctx, path, intFlagVal("end", cmd.End), tmp217, intFlagVal("pageNumber", cmd.PageNumber), intFlagVal("pageSize", cmd.PageSize), intFlagVal("start", cmd.Start))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *GetLinesJSONDataCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Internal != "" {
		var err error
		tmp218, err = boolVal(cmd.Internal)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--internal", "err", err)
			return err
		}
	}
	resp, err := c.GetLinesJSONData(ctx, path, intFlagVal("end", cmd.End), tmp218, intFlagVal("pageNumber", cmd.PageNumber), intFlagVal("pageSize", cmd.PageSize), intFlagVal("start", cmd.Start))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
