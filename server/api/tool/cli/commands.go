...
{
   "etag": "Eaque culpa unde.",
   "meta": "Cumque ut ut consequatur ea.",
   "module": "Veritatis delectus sit veritatis.",
   "profile": "Ad et corporis et quasi laborum.",
   "url": "Quia omnis dolorum."
}`,
...
{
   "key": "Est est.",
   "name": "Hic deserunt soluta similique ipsum."
}`,
...
{
   "description": "Commodi consequatur qui perspiciatis quis dolorem.",
   "name": "Ad accusantium voluptas eaque qui.",
   "slug": "na5rcbqhs3"
}`,
...
{
   "role": "Eius ipsam magnam molestiae.",
   "userId": 1746973477790832304
}`,
...
{
   "description": "Rerum numquam voluptatem.",
   "name": "n31c5gcvpi",
   "slug": "cpd1r8cixw"
}`,
...
{
   "bio": "Maiores et nobis quam.",
   "email": "henry@farrell.name",
   "invite_token": "Non sit.",
   "name": "qh9fliq9cd",
   "password": "9as0lxihni",
   "username": "yk1ltztooa"
}`,
	...
	tmp75 := new(ExpeditionGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp77 := new(GeographicalQueryGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp78 := new(GetAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp79 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp84 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp85 := new(GetIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators/USERID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp87 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp95 := new(ListAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp97 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp101 := new(ListSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp105 := new(ListByIDGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp106 := new(ListBySourceExportCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp107 := new(ListBySourceGeojsonCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp108 := new(ListBySourceQueryCommand)
	sub = &cobra.Command{
	...
	tmp109 := new(ListCurrentProjectCommand)
	sub = &cobra.Command{
	...
	tmp110 := new(ListDeviceFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp111 := new(ListDeviceDataFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp112 := new(ListDeviceLogFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp113 := new(ListDevicesFilesCommand)
	sub = &cobra.Command{
	...
	tmp114 := new(ListExpeditionIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp115 := new(ListIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp116 := new(ListIDExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/projects/PROJECTID/expeditions"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp117 := new(ListIDMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp118 := new(ListIDSourceCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp119 := new(ListIDSourceTokenCommand)
	sub = &cobra.Command{
		Use:   `source-token ["/expeditions/EXPEDITIONID/source-tokens"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp121 := new(ListIDTwitterCommand)
	sub = &cobra.Command{
		Use:   `twitter ["/expeditions/EXPEDITIONID/sources/twitter-accounts"]`,
		Short: ``,
...

{
   ...
   "username": "b4czjgkh1i"
	...
	tmp124 := new(ProjectGetIDPictureCommand)
	sub = &cobra.Command{
...
{
   "refresh_token": "Non nobis nostrum id."
}`,
	...
	tmp127 := new(StreamsProcessTasksCommand)
	sub = &cobra.Command{
	...
	tmp128 := new(SummaryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp129 := new(TemporalClusterGeometryByIDSourceCommand)
	sub = &cobra.Command{
...
{
   "deviceId": 211774014208239353,
   "firmwareId": 7990687092800462806
}`,
	...
	command.AddCommand(sub)
	tmp131 := new(UpdateDeviceCommand)
	sub = &cobra.Command{
		Use:   `device ["/sources/devices/ID"]`,
		Short: ``,
		Long: `
...
{
   "key": "Ut veniam cumque repudiandae libero sapiente.",
   "name": "Quia sit necessitatibus possimus."
}`,
	...
	command.AddCommand(sub)
	tmp132 := new(UpdateExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/expeditions/EXPEDITIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "na5rcbqhs3"
	...
	command.AddCommand(sub)
	tmp133 := new(UpdateMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members/USERID"]`,
		Short: ``,
		Long: `
...
{
   "role": "Quis rerum accusantium quia mollitia nobis."
}`,
	...
	command.AddCommand(sub)
	tmp134 := new(UpdateProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "mmrted8hyc"
	...
	command.AddCommand(sub)
	tmp135 := new(UpdateSourceCommand)
	sub = &cobra.Command{
		Use:   `source ["/sources/SOURCEID"]`,
		Short: ``,
		Long: `
...
{
   "active": false,
   "name": "Necessitatibus doloribus.",
   "teamId": 1859564489751604403,
   "userId": 497243848910407413
}`,
...
{
   "bio": "Expedita et quae omnis voluptas molestiae.",
   "email": "leonard_hilpert@zulaufanderson.name",
   "name": "9i8qvlvy4h",
   "username": "jblkmzepzc"
}`,
	...
	tmp138 := new(UpdateLocationDeviceCommand)
	sub = &cobra.Command{
...
{
   "key": "Consequuntur officiis autem soluta error expedita.",
   "latitude": 0.9404383533692007,
   "longitude": 0.8552160691989811
}`,
	...
	tmp139 := new(UpdateSchemaDeviceCommand)
	sub = &cobra.Command{
...
{
   "active": false,
   "jsonSchema": "Repellat iste illo nobis eos.",
   "key": "Non nam autem."
}`,
	...
	tmp141 := new(ValidateUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/validate"]`,
		Short: ``,
...
func (cmd *ListBySourceGeojsonCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Descending != "" {
		var err error
		tmp142, err = boolVal(cmd.Descending)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--descending", "err", err)
			return err
		}
	}
	resp, err := c.ListBySourceGeoJSON(ctx, path, tmp142)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
