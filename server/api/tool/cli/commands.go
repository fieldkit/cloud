...

{
   ...
   "url": "Sit asperiores autem."
	...
	tmp65 := new(AddAdministratorCommand)
	sub = &cobra.Command{
...

{
   ...
   "name": "Maxime sunt exercitationem a dolores non minima."
	...
	command.AddCommand(sub)
	tmp67 := new(AddExpeditionCommand)
	sub = &cobra.Command{
...

{
   ...
   "slug": "90susr7y4n"
	...
	command.AddCommand(sub)
	tmp70 := new(AddSourceTokenCommand)
	sub = &cobra.Command{
...

{
   ...
   "status_json": {
	...
	command.AddCommand(sub)
	tmp72 := new(AddStationLogCommand)
	sub = &cobra.Command{
...

{
   ...
   "password": "u9zoszx1gd"
	...
	tmp76 := new(AddMultipleStationLogCommand)
	sub = &cobra.Command{
...

{
   "station_logs": [
	...
	tmp77 := new(AllDeviceDataCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp78 := new(AllDeviceLogsCommand)
	sub = &cobra.Command{
	...
	tmp79 := new(CallbackTwitterCommand)
	sub = &cobra.Command{
	...
	tmp80 := new(CheckFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp83 := new(DeleteAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp85 := new(DeleteSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp87 := new(DeviceInfoFilesCommand)
	sub = &cobra.Command{
	...
	tmp88 := new(DownloadSimpleCommand)
	sub = &cobra.Command{
	...
	tmp89 := new(ExpeditionGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp92 := new(GeographicalQueryGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp93 := new(GetAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp94 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp98 := new(GetStationLogCommand)
	sub = &cobra.Command{
	...
	tmp100 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp101 := new(GetDeviceLocationHistoryFilesCommand)
	sub = &cobra.Command{
	...
	tmp102 := new(GetIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators/USERID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp104 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp106 := new(GetIDProjectCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp108 := new(GetIDTwitterCommand)
	sub = &cobra.Command{
	...
	tmp110 := new(ListFirmwareCommand)
	sub = &cobra.Command{
		Use:   `firmware ["/firmware"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp111 := new(ListAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp113 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp117 := new(ListSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp122 := new(ListByIDGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp123 := new(ListBySourceExportCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp124 := new(ListBySourceGeojsonCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp125 := new(ListBySourceQueryCommand)
	sub = &cobra.Command{
	...
	tmp126 := new(ListCurrentProjectCommand)
	sub = &cobra.Command{
	...
	tmp127 := new(ListDeviceFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp128 := new(ListDeviceDataFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp129 := new(ListDeviceLogFilesFilesCommand)
	sub = &cobra.Command{
	...
	tmp130 := new(ListDevicesFilesCommand)
	sub = &cobra.Command{
	...
	tmp131 := new(ListExpeditionIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp132 := new(ListIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp133 := new(ListIDExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/projects/PROJECTID/expeditions"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp134 := new(ListIDMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp135 := new(ListIDSourceCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp136 := new(ListIDSourceTokenCommand)
	sub = &cobra.Command{
		Use:   `source-token ["/expeditions/EXPEDITIONID/source-tokens"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp138 := new(ListIDTwitterCommand)
	sub = &cobra.Command{
		Use:   `twitter ["/expeditions/EXPEDITIONID/sources/twitter-accounts"]`,
		Short: ``,
...

{
   ...
   "password": "2yacoldg4n"
	...
	tmp141 := new(MyFeaturesSimpleCommand)
	sub = &cobra.Command{
	...
	tmp142 := new(MySimpleSummarySimpleCommand)
	sub = &cobra.Command{
	...
	tmp144 := new(ProjectGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp146 := new(RefreshTasksCommand)
	sub = &cobra.Command{
...

{
   "refresh_token": "Aliquid hic soluta ab quia enim rem."
	...
	tmp149 := new(SummaryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp150 := new(TemporalClusterGeometryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp151 := new(UpdateFirmwareCommand)
	sub = &cobra.Command{
...

{
   ...
   "firmwareId": 8088060880983347600
	...
	command.AddCommand(sub)
	tmp152 := new(UpdateDeviceCommand)
	sub = &cobra.Command{
		Use:   `device ["/sources/devices/ID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "name": "Qui asperiores amet aliquid et."
	...
	command.AddCommand(sub)
	tmp153 := new(UpdateExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/expeditions/EXPEDITIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "q9cd69as0l"
	...
	command.AddCommand(sub)
	tmp154 := new(UpdateMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members/USERID"]`,
		Short: ``,
		Long: `
...

{
   "role": "Quia reprehenderit voluptates consequatur sed."
	...
	command.AddCommand(sub)
	tmp155 := new(UpdateProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "90susr7y4n"
	...
	command.AddCommand(sub)
	tmp156 := new(UpdateSourceCommand)
	sub = &cobra.Command{
		Use:   `source ["/sources/SOURCEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "userId": 2674357303679900026
	...
	command.AddCommand(sub)
	tmp157 := new(UpdateStationCommand)
	sub = &cobra.Command{
		Use:   `station ["/stations/STATIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "status_json": {
      "Ex alias sunt repellendus.": "3be80140-ef32-4db7-9e38-8398ad996fc1"
   }
}`,
	...
	command.AddCommand(sub)
	tmp158 := new(UpdateStationLogCommand)
	sub = &cobra.Command{
...

{
   ...
   "name": "zntdngxk4x"
	...
	tmp161 := new(UpdateDeviceInfoFilesCommand)
	sub = &cobra.Command{
		Use:   `files ["/devices/DEVICEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "notes": "Eveniet alias fuga."
	...
	tmp162 := new(UpdateLocationDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "longitude": 0.7161119903509889
	...
	tmp163 := new(UpdateSchemaDeviceCommand)
	sub = &cobra.Command{
...

{
   ...
   "key": "Illo beatae officia dolores facere."
	...
	tmp164 := new(UserGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp165 := new(ValidateUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/validate"]`,
		Short: ``,
...
func (cmd *ListBySourceGeojsonCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Descending != "" {
		var err error
		tmp166, err = boolVal(cmd.Descending)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--descending", "err", err)
			return err
		}
	}
	resp, err := c.ListBySourceGeoJSON(ctx, path, tmp166)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *RawFilesCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Dl != "" {
		var err error
		tmp168, err = boolVal(cmd.Dl)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--dl", "err", err)
			return err
		}
	}
	resp, err := c.RawFiles(ctx, path, tmp168)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
