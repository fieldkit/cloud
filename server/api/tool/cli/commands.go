...
type (
	...
	// CsvStreamsCommand is the command line data structure for the csv action of Streams
	CsvStreamsCommand struct {
		StreamID    string
		PrettyPrint bool
	}

	// DeviceCsvStreamsCommand is the command line data structure for the device csv action of Streams
	DeviceCsvStreamsCommand struct {
		DeviceID    string
		FileID      string
		PrettyPrint bool
	}

	// DeviceRawStreamsCommand is the command line data structure for the device raw action of Streams
	DeviceRawStreamsCommand struct {
		DeviceID    string
		FileID      string
		PrettyPrint bool
	}

	// JSONStreamsCommand is the command line data structure for the json action of Streams
	JSONStreamsCommand struct {
		StreamID    string
		PrettyPrint bool
	}
	...
	// ListDevicesStreamsCommand is the command line data structure for the list devices action of Streams
	ListDevicesStreamsCommand struct {
		PrettyPrint bool
	}

	// RawStreamsCommand is the command line data structure for the raw action of Streams
	RawStreamsCommand struct {
		StreamID    string
		PrettyPrint bool
	}
...
{
   "etag": "Eum veniam sequi.",
   "meta": "Aspernatur nulla rerum aliquam rerum esse dignissimos.",
   "module": "Quaerat occaecati est.",
   ...
   "url": "A quia aut."
	...
	tmp58 := new(AddAdministratorCommand)
	sub = &cobra.Command{
...

{
   ...
   "name": "Aut hic."
	...
	command.AddCommand(sub)
	tmp60 := new(AddExpeditionCommand)
	sub = &cobra.Command{
...
{
   "description": "Iure hic deserunt soluta similique ipsum.",
...
{
   "description": "Sunt commodi consequatur qui.",
   "name": "Quis dolorem ipsam ad accusantium.",
   "slug": "5nzna5rcbq"
}`,
	...
	command.AddCommand(sub)
	tmp63 := new(AddSourceTokenCommand)
	sub = &cobra.Command{
...
{
   "name": "Aut reiciendis doloremque autem necessitatibus doloribus et."
}`,
...

{
   ...
   "invite_token": "Asperiores amet aliquid et corrupti laudantium.",
   "name": "6g6qg0z6y1",
   "password": "o27o19cvxj",
   "username": "1bm6qh9fli"
}`,
	...
	tmp67 := new(CallbackTwitterCommand)
	sub = &cobra.Command{
	...
	tmp68 := new(CheckFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp70 := new(CsvStreamsCommand)
	sub = &cobra.Command{
		Use:   `streams ["/streams/STREAMID/csv"]`,
		Short: ``,
	...
	tmp71 := new(DeleteAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp73 := new(DeleteSourceTokenCommand)
	sub = &cobra.Command{
	...
	command = &cobra.Command{
		Use:   "device-csv",
		Short: `Export device streams`,
	}
	tmp75 := new(DeviceCsvStreamsCommand)
	sub = &cobra.Command{
		Use:   `streams ["/devices/DEVICEID/streams/csv"]`,
		Short: ``,
	...
	tmp76 := new(DeviceRawStreamsCommand)
	sub = &cobra.Command{
		Use:   `streams ["/devices/DEVICEID/streams/raw"]`,
		Short: ``,
	...
	tmp77 := new(ExpeditionGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp79 := new(GeographicalQueryGeojsonCommand)
	sub = &cobra.Command{
	...
	tmp80 := new(GetAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp81 := new(GetExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp86 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp87 := new(GetIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators/USERID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp89 := new(GetIDExpeditionCommand)
	sub = &cobra.Command{
	...
	tmp95 := new(JSONStreamsCommand)
	sub = &cobra.Command{
		Use:   `streams ["/streams/STREAMID/json"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp97 := new(ListAdministratorCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp99 := new(ListExpeditionCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp103 := new(ListSourceTokenCommand)
	sub = &cobra.Command{
	...
	tmp115 := new(ListDevicesStreamsCommand)
	sub = &cobra.Command{
		Use:   `streams ["/streams/devices"]`,
		Short: ``,
	...
	tmp116 := new(ListExpeditionIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp117 := new(ListIDAdministratorCommand)
	sub = &cobra.Command{
		Use:   `administrator ["/projects/PROJECTID/administrators"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp118 := new(ListIDExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/projects/PROJECTID/expeditions"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp119 := new(ListIDMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp120 := new(ListIDSourceCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp121 := new(ListIDSourceTokenCommand)
	sub = &cobra.Command{
		Use:   `source-token ["/expeditions/EXPEDITIONID/source-tokens"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp123 := new(ListIDTwitterCommand)
	sub = &cobra.Command{
		Use:   `twitter ["/expeditions/EXPEDITIONID/sources/twitter-accounts"]`,
		Short: ``,
...

{
   ...
   "username": "hnipyk1ltz"
	...
	tmp126 := new(ProjectGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp127 := new(RawStreamsCommand)
	sub = &cobra.Command{
		Use:   `streams ["/streams/STREAMID/raw"]`,
		Short: ``,
...
{
   "refresh_token": "Facere tempora ut eveniet."
}`,
	...
	tmp129 := new(StreamsProcessTasksCommand)
	sub = &cobra.Command{
	...
	tmp130 := new(SummaryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp131 := new(TemporalClusterGeometryByIDSourceCommand)
	sub = &cobra.Command{
	...
	tmp132 := new(UpdateFirmwareCommand)
	sub = &cobra.Command{
...
{
   "deviceId": 6936376325543937434,
   "firmwareId": 8282634339368904059
}`,
	...
	command.AddCommand(sub)
	tmp133 := new(UpdateDeviceCommand)
	sub = &cobra.Command{
		Use:   `device ["/sources/devices/ID"]`,
		Short: ``,
		Long: `
...
{
   "key": "Est rem quisquam repellat autem.",
   "name": "Unde eaque culpa unde iusto cumque ut."
	...
	command.AddCommand(sub)
	tmp134 := new(UpdateExpeditionCommand)
	sub = &cobra.Command{
		Use:   `expedition ["/expeditions/EXPEDITIONID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "dpz83ljd52"
	...
	command.AddCommand(sub)
	tmp135 := new(UpdateMemberCommand)
	sub = &cobra.Command{
		Use:   `member ["/teams/TEAMID/members/USERID"]`,
		Short: ``,
		Long: `
...
{
   "role": "Iste illo nobis eos asperiores non nam."
}`,
	...
	command.AddCommand(sub)
	tmp136 := new(UpdateProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "slug": "5nzna5rcbq"
	...
	command.AddCommand(sub)
	tmp137 := new(UpdateSourceCommand)
	sub = &cobra.Command{
		Use:   `source ["/sources/SOURCEID"]`,
		Short: ``,
		Long: `
...
{
   "active": false,
   "name": "Aut et eius ipsam magnam molestiae a.",
   "teamId": 2487355362923204623,
   "userId": 1154982594287629222
}`,
...
{
   "bio": "Fuga explicabo.",
   "email": "erick_trantow@daniel.net",
   "name": "nkyddwfvj3",
   "username": "wa2lzzs51w"
}`,
	...
	tmp140 := new(UpdateLocationDeviceCommand)
	sub = &cobra.Command{
...
{
   "key": "Consequatur ea repudiandae veritatis delectus sit.",
   "latitude": 0.43811232128546845,
   "longitude": 0.224541934525807
}`,
	...
	tmp141 := new(UpdateSchemaDeviceCommand)
	sub = &cobra.Command{
...
{
   "active": false,
   "jsonSchema": "Corporis et quasi laborum et quia.",
   "key": "Dolorum aut blanditiis adipisci nam est."
}`,
	...
	tmp142 := new(UserGetIDPictureCommand)
	sub = &cobra.Command{
	...
	tmp143 := new(ValidateUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/validate"]`,
		Short: ``,
...
func (cmd *ListBySourceGeojsonCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Descending != "" {
		var err error
		tmp144, err = boolVal(cmd.Descending)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--descending", "err", err)
			return err
		}
	}
	resp, err := c.ListBySourceGeoJSON(ctx, path, tmp144)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// Run makes the HTTP request corresponding to the CsvStreamsCommand command.
func (cmd *CsvStreamsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
		path = fmt.Sprintf("/streams/%v/csv", url.QueryEscape(cmd.StreamID))
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.CsvStreams(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *CsvStreamsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var streamID string
	cc.Flags().StringVar(&cmd.StreamID, "streamId", streamID, ``)
}

// Run makes the HTTP request corresponding to the DeviceCsvStreamsCommand command.
func (cmd *DeviceCsvStreamsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
		path = fmt.Sprintf("/devices/%v/streams/csv", url.QueryEscape(cmd.DeviceID))
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.DeviceCsvStreams(ctx, path, stringFlagVal("file_id", cmd.FileID))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *DeviceCsvStreamsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var deviceID string
	cc.Flags().StringVar(&cmd.DeviceID, "deviceId", deviceID, ``)
	var fileID string
...
// Run makes the HTTP request corresponding to the DeviceRawStreamsCommand command.
func (cmd *DeviceRawStreamsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
		path = fmt.Sprintf("/devices/%v/streams/raw", url.QueryEscape(cmd.DeviceID))
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.DeviceRawStreams(ctx, path, stringFlagVal("file_id", cmd.FileID))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *DeviceRawStreamsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var deviceID string
	cc.Flags().StringVar(&cmd.DeviceID, "deviceId", deviceID, ``)
	var fileID string
	cc.Flags().StringVar(&cmd.FileID, "file_id", fileID, ``)
...
// Run makes the HTTP request corresponding to the JSONStreamsCommand command.
func (cmd *JSONStreamsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
		path = fmt.Sprintf("/streams/%v/json", url.QueryEscape(cmd.StreamID))
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.JSONStreams(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *JSONStreamsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var streamID string
	cc.Flags().StringVar(&cmd.StreamID, "streamId", streamID, ``)
}
...
// Run makes the HTTP request corresponding to the ListDevicesStreamsCommand command.
func (cmd *ListDevicesStreamsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
		path = "/streams/devices"
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.ListDevicesStreams(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ListDevicesStreamsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
}

// Run makes the HTTP request corresponding to the RawStreamsCommand command.
func (cmd *RawStreamsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
		path = fmt.Sprintf("/streams/%v/raw", url.QueryEscape(cmd.StreamID))
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.RawStreams(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RawStreamsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var streamID string
	cc.Flags().StringVar(&cmd.StreamID, "streamId", streamID, ``)
}
