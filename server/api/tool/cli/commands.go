...
{
   "etag": "Cupiditate ullam.",
   "meta": "Placeat consequatur quod eum.",
   "module": "Sequi eum aspernatur nulla rerum aliquam.",
   "profile": "Esse dignissimos mollitia.",
   "url": "Occaecati est consequatur dolorum voluptas omnis."
}`,
...
{
   "category_id": 6342210647832459428,
   "created": "1973-05-29T10:53:50Z",
   "media_id": 1280577983779309995,
   "note": "A quia aut."
}`,
...
{
   "description": "Rem atque in debitis.",
   "endTime": "Velit aut hic.",
   "goal": "Est rem quisquam repellat autem.",
   "location": "Unde eaque culpa unde iusto cumque ut.",
   "name": "Consequatur ea repudiandae veritatis delectus sit.",
   "private": false,
   "slug": "76xcws9vmo",
   "startTime": "Blanditiis adipisci nam est.",
   "tags": "Iure hic deserunt soluta similique ipsum."
}`,
...
{
   "email": "annabelle@lebsackfay.name",
   "invite_token": "Aut et eius ipsam magnam molestiae a.",
   "name": "y8w3ljezym",
   "password": "o95gdvcbmm"
}`,
	...
	tmp72 := new(AddStationProjectCommand)
	sub = &cobra.Command{
	...
	tmp73 := new(ChangePasswordUserCommand)
	sub = &cobra.Command{
...
{
   "newPassword": "ted8hycrrc",
   "oldPassword": "zxi7noyn31"
}`,
	...
	tmp75 := new(DeleteFirmwareCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp76 := new(DeleteFieldNoteCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp77 := new(DeleteProjectCommand)
	sub = &cobra.Command{
	...
	tmp78 := new(DeviceDataDataCommand)
	sub = &cobra.Command{
	...
	tmp79 := new(DeviceSummaryDataCommand)
	sub = &cobra.Command{
	...
	tmp80 := new(DownloadFirmwareCommand)
	sub = &cobra.Command{
	...
	tmp81 := new(FilteredRecordsCommand)
	sub = &cobra.Command{
	...
	tmp85 := new(GetCurrentUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user"]`,
		Short: ``,
	...
	tmp86 := new(GetCurrentUserImageUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user/media"]`,
		Short: ``,
	...
	tmp88 := new(GetMediaFieldNoteCommand)
	sub = &cobra.Command{
	...
	tmp89 := new(GetUserImageUserCommand)
	sub = &cobra.Command{
	...
	tmp90 := new(InviteUserProjectCommand)
	sub = &cobra.Command{
...
{
   "email": "Ut veniam cumque repudiandae libero sapiente.",
   "role": 5748594890616086049
}`,
	...
	tmp93 := new(ListByProjectUserCommand)
	sub = &cobra.Command{
	...
	tmp95 := new(ListStationProjectCommand)
	sub = &cobra.Command{
...
{
   "email": "saul.kshlerin@mitchellreichert.biz",
   "password": "0imp6g6qg0"
}`,
	...
	tmp100 := new(ProjectRolesUserCommand)
	sub = &cobra.Command{
	...
	tmp101 := new(RecoveryUserCommand)
	sub = &cobra.Command{
...
{
   "password": "6y1io27o19",
   "token": "Dolores facere veritatis quod voluptas non sit."
}`,
	...
	tmp102 := new(RecoveryLookupUserCommand)
	sub = &cobra.Command{
...
{
   "email": "Officia ipsa quam consectetur rerum."
}`,
...
{
   "refresh_token": "Ducimus assumenda quod nesciunt."
}`,
	...
	tmp104 := new(RemoveStationProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID/stations/STATIONID"]`,
		Short: ``,
	...
	tmp105 := new(RemoveUserProjectCommand)
	sub = &cobra.Command{
...

{
   "email": "Sit necessitatibus."
	...
	tmp106 := new(ResolvedRecordsCommand)
	sub = &cobra.Command{
	...
	tmp107 := new(SaveCurrentUserImageUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/user/media"]`,
		Short: ``,
	...
	tmp108 := new(SaveMediaFieldNoteCommand)
	sub = &cobra.Command{
	...
	tmp109 := new(SendValidationUserCommand)
	sub = &cobra.Command{
	...
	tmp110 := new(SummaryJSONDataCommand)
	sub = &cobra.Command{
	...
	tmp111 := new(TransmissionTokenUserCommand)
	sub = &cobra.Command{
	...
	tmp112 := new(UpdateFieldNoteCommand)
	sub = &cobra.Command{
		Use:   `field-note ["/stations/STATIONID/field-notes/FIELDNOTEID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "note": "A quia aut."
	...
	command.AddCommand(sub)
	tmp113 := new(UpdateProjectCommand)
	sub = &cobra.Command{
		Use:   `project ["/projects/PROJECTID"]`,
		Short: ``,
		Long: `
...

{
   ...
   "name": "ijq90susr7"
	...
	tmp116 := new(UserSaveIDPictureCommand)
	sub = &cobra.Command{
		Use:   `picture ["/users/USERID/picture"]`,
		Short: ``,
	...
	tmp117 := new(ValidateUserCommand)
	sub = &cobra.Command{
		Use:   `user ["/validate"]`,
		Short: ``,
...
func (cmd *GetJSONDataCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Internal != "" {
		var err error
		tmp118, err = boolVal(cmd.Internal)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--internal", "err", err)
			return err
		}
	}
	resp, err := c.GetJSONData(ctx, path, intFlagVal("end", cmd.End), tmp118, intFlagVal("page", cmd.Page), intFlagVal("pageSize", cmd.PageSize), intFlagVal("start", cmd.Start))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *SummaryJSONDataCommand) Run(c *client.Client, args []string) error {
	...
	if cmd.Internal != "" {
		var err error
		tmp119, err = boolVal(cmd.Internal)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--internal", "err", err)
			return err
		}
	}
	resp, err := c.SummaryJSONData(ctx, path, intFlagVal("end", cmd.End), tmp119, intFlagVal("interval", cmd.Interval), intFlagVal("page", cmd.Page), intFlagVal("pageSize", cmd.PageSize), intFlagVal("resolution", cmd.Resolution), intFlagVal("start", cmd.Start))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
