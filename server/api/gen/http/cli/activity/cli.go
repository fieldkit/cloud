...
Example:
    `+os.Args[0]+` export status --id "Voluptates delectus aut non tenetur et et." --auth "Sed et animi aut possimus."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` export download --id "Laboriosam incidunt aut." --auth "Hic est adipisci."
`, os.Args[0])
}
