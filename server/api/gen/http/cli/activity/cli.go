...
Example:
    `+os.Args[0]+` records data --record-id 4372705222273354592 --auth "Ducimus architecto aut id."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` records meta --record-id 406445576790905224 --auth "Hic architecto est."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` records resolved --record-id 9075164358945395604 --auth "Fugiat ullam et aspernatur adipisci aut."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` sensor station- meta --stations "Qui odit nobis molestiae autem officia quis."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` sensor data --start 5850135895231040537 --end 2422523651513226986 --stations "Repellat consequuntur reiciendis ullam." --sensors "Minima molestias sequi id ratione." --resolution 1514150742 --aggregate "Ipsum et." --complete true --tail 77431479 --backend "Praesentium possimus ut vel ut." --auth "Corrupti accusamus similique."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` sensor tail --stations "Est tempora nisi." --backend "Minus saepe aperiam." --auth "Reiciendis tenetur sit."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` sensor recently --stations "Error nihil id id." --auth "Atque ducimus id tempore ratione."
`, os.Args[0])
}
