...
Example:
    `+os.Args[0]+` station download- photo --station-id 1333193181 --size 509820601 --if-none-match "Et ut nisi et est a." --auth "Ut debitis voluptas voluptas odit quis ratione."
`, os.Args[0])
}
