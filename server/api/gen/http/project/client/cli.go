...
func BuildGetProjectsForStationPayload(projectGetProjectsForStationID string, projectGetProjectsForStationAuth string) (*project.GetProjectsForStationPayload, error) {
	var err error
	var id int32
	{
		var v int64
	...
	var auth *string
	{
		if projectGetProjectsForStationAuth != "" {
