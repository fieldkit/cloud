...
// NewListMineUserExportsOK builds a "csv" service "list mine" endpoint result
// from a HTTP "OK" response.
func NewListMineUserExportsOK(body *ListMineResponseBody) *csvviews.UserExportsView {
	v := &csvviews.UserExportsView{}
	v.Exports = make([]*csvviews.ExportStatusView, len(body.Exports))
	for i, val := range body.Exports {
		v.Exports[i] = unmarshalExportStatusResponseBodyToCsvviewsExportStatusView(val)
	}

	return v
}

// NewListMineUnauthorized builds a csv service list mine endpoint unauthorized
// error.
...
// NewListMineForbidden builds a csv service list mine endpoint forbidden error.
...
// NewListMineNotFound builds a csv service list mine endpoint not-found error.
...
// NewListMineBadRequest builds a csv service list mine endpoint bad-request
// error.
