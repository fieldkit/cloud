...
func MountFieldkitController(service *goa.Service, ctrl FieldkitController) {
	...
	h = handleSecurity("jwt", h, "api:access")
	h = handleFieldkitOrigin(h)
	service.Mux.Handle("GET", "/inputs/fieldkits/:input_id", ctrl.MuxHandler("get id", h, nil))
	...
	h = handleSecurity("jwt", h, "api:access")
	h = handleFieldkitOrigin(h)
	service.Mux.Handle("GET", "/expeditions/:expedition_id/inputs/fieldkits", ctrl.MuxHandler("list id", h, nil))
