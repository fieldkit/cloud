...
type updateDeviceFirmwarePayload struct {
	...
	FirmwareID *int `form:"firmwareId,omitempty" json:"firmwareId,omitempty" xml:"firmwareId,omitempty"`
}
...
type UpdateDeviceFirmwarePayload struct {
	...
	FirmwareID int `form:"firmwareId" json:"firmwareId" xml:"firmwareId"`
}
