...
class Lightbox extends React.Component {
    ...
    openPreviousDocument(e) {
        const {previousDocumentID, openLightbox} = this.props
    ...
    openNextDocument(e) {
        const {nextDocumentID, openLightbox} = this.props
        if (!!nextDocumentID) {
    ...
    onClick() {
        const {data, closeLightbox} = this.props
    ...
    render() {
        const {data, currentExpeditionID, updateDate, closeLightbox} = this.props
        ...
        return (
            <div className="lightbox">
                ...
                <div className="lightbox_content" style={ { padding: `0 ${ 1.388888889 * 12.5 }vw` } } onClick={ closeLightbox }>
                    ...
                    <div className="lightbox_content_main">
                        ...
                        <div className="post_main_meta">
                            ...
                            <div className="post_main_meta_geo">
                                <Link to={ '/' + currentExpeditionID + '/map' } onClick={ this.onClick }>
                    ...
                    <div className="lightbox_content_actions">
                        <div className="button" onClick={ this.openPreviousDocument }>
                            <img src={ '/' + iconBackward } />
                        </div>
                        <div className="button" onClick={ this.openNextDocument }>
                            <img src={ '/' + iconForward } />
                        </div>
                    </div>
                </div>
