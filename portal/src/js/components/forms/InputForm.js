        ...
        return (
            <FormContainer onSave={ this.save.bind(this) } onCancel={ this.props.onCancel } saveText={ this.props.saveText } cancelText={ this.props.cancelText }>
                <div className="form-group">
                    <FormItem labelText={ 'Name' } name={ 'name' } className={ 'lg' } type={ 'text' } value={ name } onChange={ this.handleInputChange.bind(this) }
                        errors={ errors } />
                </div>
                { input &&
                  <div>
                      ...
                      { bindingType === "team" &&
                        <div className="form-group">
                            ...
                            <select name="team_id" value={ team_id } onChange={ this.handleBindingChange.bind(this) }>
                                ...
                                { teams.map((team, i) => <option key={ i } value={ team.id }>
                                                             { team.name }
                                                         </option>) }
                            </select>
                      ...
                      { bindingType === "member" &&
                        <div className="form-group">
                            ...
                            <select name="user_id" value={ user_id } onChange={ this.handleBindingChange.bind(this) }>
                                ...
                                { Object.keys(users).map(id => <option key={ id } value={ id }>
                                                                   { users[id].username }
                                                               </option>) }
                            </select>
