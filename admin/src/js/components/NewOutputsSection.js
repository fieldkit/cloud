...
class NewOutputsSection extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      addMemberValue: null,
  ...
  render () {
    ...
    return (
      <div id="teams-section" className="section">
        ...
        <div className="columns-container">
          <div className="main-input-container">
            <textarea rows="4" cols="50" onChange={e => {
              ...
              {currentExpedition.get('description')}
            </textarea>
          </div>
          <p className="input-description">
            Etiam pretium ante non egestas dapibus. Mauris pretium, nunc non lacinia finibus, dui lectus molestie nulla, quis ultricies libero orci a sapien.
        ...
        <div className="columns-container">
          <ul className="main-input-container">
            <li
              ...
              onClick={() => {
                setExpeditionProperty('selectedPreset', 'rookie')
              }}
            >
              <h2>
                Rookie expedition
            ...
            <li
              ...
              onClick={() => {
                setExpeditionProperty('selectedPreset', 'advanced')
              }}
            >
              <h2>
                Advanced expedition
            ...
            <li
              ...
              onClick={() => {
                setExpeditionProperty('selectedPreset', 'pro')
              }}
            >
              <h2>
                Start from scratch
        ...
        <Link to={'/admin/' + currentExpedition.get('id') }>
          <div className="button hero">
            Your expedition is ready, congratulations!
          </div>
        </Link>
...
NewOutputsSection.propTypes = {
}

export default NewOutputsSection
