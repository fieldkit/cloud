...
export class MembersTable extends Component {
    ...
    async save() {
        ...
        const errors = await onUpdate(teamId, user_id, {
            role: role
        });
        if (errors) {
            this.setState({
                                                         ...
                                                         { users[member.user_id] &&
                                                           <div>
                                                               ...
                                                               <p className="type-small">
                                                                   { users[member.user_id].username }
                                                               </p>
                                                           </div> }
                                                     </td>
                                                     <td>
                                                         <input type="text" value={ member.user_id === user_id ? role : member.role } name="role" disabled={ member.user_id !== user_id } onChange={ this.handleInputChange.bind(this) } onKeyUp={ this.handleKeyUp.bind(this) } onBlur={ this.handleBlur.bind(this) }
                                                         />
