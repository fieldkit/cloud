...
export default class VizGroupingForm extends Component {
    props: {
    data: Viz,
    errors: ?APIErrors,
    creator: Object,
            ...
            <div>
                <div>
                    <div>
                        ...
                        <MultiSelect name={ 'source_collection' } value={ selected_collections } options={ collection_options } multi={ true } simpleValue={ true } joinValues={ true }
                            onChange={ this.updateSelectedCollections } multiple={ true } options={ collection_options } />
                    </div>
                    <FormSelectItem labelText={ 'Grouping Operation' } name={ 'grouping_operation' } value={ grouping_operation.operation } inline={ true } firstOptionText={ 'Select' }
                        options={ grouping_ops } errors={ errors } onChange={ this.updateGroupingOperation } />
                    <FormSelectItem labelText={ 'Grouping Attribute' } name={ 'grouping_attribute' } value={ grouping_operation.source_attribute.name } inline={ true } firstOptionText={ 'Select' }
                        options={ grouping_attrs } errors={ errors } onChange={ this.updateGroupingAttribute } />
                    { grouping_operation.operation === 'within' &&
                      <FormItem labelText={ 'Grouping Param' } name={ 'grouping_param' } value={ grouping_operation.parameter || '' } inline={ true } errors={ errors } onChange={ this.updateGroupingParameter }
                      /> }
                </div>
            </div>
            );
